...
If a finding depends on an assumption you could not verify, say so in one line outside the Issues table - do not convert an unverified assumption into a finding. Never apply a fix based on an unverified assumption.
