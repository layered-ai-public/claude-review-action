...
If a finding depends on an assumption you could not verify, say so in a single "Assumptions" line after the Issues section - do not convert an unverified assumption into a finding. Never apply a fix based on an unverified assumption.
